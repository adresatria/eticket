                        ...
                        <div class="container">
                            <div class="main-sidemenu navbar px-0">
                                ...
                                <ul class="side-menu">
                                    ...
                                    <li class="slide">
                                        <a class="side-menu__item" data-bs-toggle="slide" href="#Faq"><span
                                ...
                                <div class="header-nav-right d-flex">
                                    <a href="#" target="_blank"
                                        class="btn btn-pill btn-outline-primary btn-w-md py-2 me-1 my-auto  d-lg-none d-xl-block d-block">
                                        Sign up
                                    </a>
                                    <a href="login" 
                        ...
                        <div class="overflow-hidden">
                            <div class="row">
                                <div class="col-lg-6 text-left pos-relative overflow-hidden p-3">
                                    <h1 class="text-shadow text-dark">Hello! Welcome to <span
                                            class="text-primary">PIKU</span></h1>
                                    <h6 class="mt-3">Piknik Teluk Penyu atau Piku adalah platform inovatif yang
                                        memudahkan Anda dalam memesan
                                        e-ticket untuk destinasi wisata pantai Teluk Penyu dan Benteng Pendem.
                                        Melalui Piku, Anda bisa dengan mudah mendapatkan tiket masuk untuk menikmati
                                        keindahan Pantai Teluk Penyu dan mengeksplorasi kekayaan sejarah Benteng Pendem.
                                        Nikmati kemudahan pemesanan tiket secara online, sehingga Anda dapat
                                        merencanakan liburan tanpa repot. Piku memastikan pengalaman wisata Anda lebih
                                        nyaman dan menyenangkan dengan pelayanan cepat dan aman. Jelajahi keindahan alam
                                        dan sejarah dengan hanya beberapa klik di Piku!</h6>
                                    {{-- <h6 class="mb-4">We create our templates in a very professional manner to satisfy
                                        our
                                        clients.</h6> --}}
                                    {{-- <a href="#" class="btn btn-pill btn-primary btn-w-md py-2 me-2 mb-1">Buy
                                        Now<i class="fe fe-activity ms-2"></i></a>
                                ...
                                <div class="col-lg-6 text-left pos-relative overflow-hidden market-image">
                                    <img alt="" class="logo-2"
                                        src="{{ asset('../assets/images/landing/telukpenyu.jpeg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="container px-5 px-md-0">
                                <div class="row text-center">
                                    <div class="col-lg-12">
                                        ...
                                        <p class="text-default sub-text">Platform Terpercaya untuk Pemesanan E-Ticket
                                            ke Pantai Teluk Penyu dan Benteng Pendem, Membuat Liburan Anda Lebih Mudah
                                            dan Menyenangkan</p>
                                    </div>
                                </div>
                                {{-- <div class="row mt-5">
                                    <div class="col-lg-3 col-sm-6 why-image">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="mb-2">
                                                    <img class="img-fluid"
                                                        src="../assets/images/landing/Why/web-designing.png"
                                                        alt="">
                                                </div>
                                                <p class="why-head mb-2">Design Quality</p>
                                                <p class="fs-13">Lorem ipsum dolor sit amet consectetur adipisicing
                                                    elit. Omnis
                                                    labore </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 why-image">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="mb-2">
                                                    <img class="img-fluid"
                                                        src="../assets/images/landing/Why/documentation.png"
                                                        alt="">
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 why-image">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="mb-2">
                                                    <img class="img-fluid"
                                                        src="../assets/images/landing/Why/web-settings.png"
                                                        alt="">
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 why-image">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="mb-2">
                                                    <img class="img-fluid"
                                                        src="../assets/images/landing/Why/update.png" alt="">
                                                </div>
                            ...
                            <div class="container px-5 px-md-0">
                                <div class="row justify-content-center text-center">
                                    <div class="col-lg-8 ps-4 mb-lg-0- mb-4">
                                        ...
                                        <p class="text-default sub-text mb-0">This template is responsively made and
                                            can suitable for all
                                            ...
                                            <div class="slide">
                                                <div class="row align-items-center">
                                                    <div class="col-md-7 col-12 px-0">
                                                        ...
                                                        <p class="text-muted mb-4">More advanced pages are included in
                                                            this template some of
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-12">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="ms-3">
                                                                        <p>Can Switch Easily From Vertical to
                                                                            HorizontalMenu.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-5 col-12">
                                                        <img class="img-fluid float-md-end"
                                                            src="../assets/images/landing/desktop.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- <div class="slide">
                                                <div class="row align-items-center">
                                                    <div class="col-md-7 col-12  px-0">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="ms-3">
                                                                        <p>Switch Easily From FullWidth to Boxed Layout.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-12">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="ms-3">
                                                                        <p>Switch Easily From Fixed to Scrollable
                                                                            Layout.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="ms-3">
                                                                        <p>Switch Easily From One Color to Another Color
                                                                            style</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <a href="#"
                                                            class="btn btn-pill btn-primary btn-w-md py-2 me-2">Demo<i
                                                                class="fe fe-file-text mx-2"></i></a>
                                                    </div>
                                                    <div class="col-md-5 col-sm-12">
                                                        <img class="img-fluid float-md-end"
                                                            src="../assets/images/landing/laptop.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slide">
                                                <div class="row align-items-center">
                                                    <div class="col-md-7 col-12  px-0">
                                                        ...
                                                        <a href="#"
                                                            class="btn btn-pill btn-secondary btn-w-md py-2 me-2">Licenses<i
                                                                class="fe fe-file-text mx-2"></i></a>
                                                    </div>
                                                    <div class="col-md-5 col-sm-12">
                                                        <img class="img-fluid float-md-end"
                                                            src="../assets/images/landing/tablet.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slide">
                                                <div class="row align-items-center">
                                                    <div class="col-md-7 col-12 px-0">
                                                        ...
                                                        <a href="#"
                                                            class="btn btn-pill btn-primary btn-w-md py-2 me-2">Buy
                                                            Now<i class="fe fe-activity ms-2"></i></a>
                                                    </div>
                                                    <div class="col-md-5 col-sm-12">
                                                        <img class="img-fluid float-md-end"
                                                            src="../assets/images/landing/mobile.png" alt="">
                                                    </div>
                                                </div>
                                            </div> --}}
                                        </div>
                            ...
                            <div class="container px-5 px-md-0">
                                <div class="row text-center justify-content-center">
                                    <div class="col-lg-8 ps-4">
                                        ...
                                        <p class="text-default sub-text mb-0">Noa comes with multiple customizable
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-5 customize-image text-center">
                                        <img class="img-fluid p-5" src="../assets/images/landing/customize.png"
                                            alt="">
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-3">
                                                        <p>followed design standards to compete in the existing market.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <ul id="lightgallery" class="list-unstyled row">
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media"
                                        ...
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive br-5 wp-100" src="../assets/images/media/1.jpg"
                                                alt="Thumb-1">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/4.jpg"
                                        data-src="../assets/images/media/4.jpg"
                                        data-sub-html=" <h4>Gallery Image 4</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive br-5 wp-100" src="../assets/images/media/4.jpg"
                                                alt="Thumb-2">
                                        </a>
                                    </li>

                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/5.jpg"
                                        data-src="../assets/images/media/5.jpg"
                                        data-sub-html="<h4>Gallery Image 5</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive br-5 wp-100" src="../assets/images/media/5.jpg"
                                                alt="Thumb-1">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/6.jpg"
                                        data-src="../assets/images/media/6.jpg"
                                        data-sub-html="<h4>Gallery Image 6</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive br-5 wp-100" src="../assets/images/media/6.jpg"
                                                alt="Thumb-2">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/7.jpg"
                                        data-src="../assets/images/media/7.jpg"
                                        data-sub-html="<h4>Gallery Image 7</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive br-5 wp-100" src="../assets/images/media/7.jpg"
                                                alt="Thumb-1">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/8.jpg"
                                        ...
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive br-5 wp-100" src="../assets/images/media/8.jpg"
                                                alt="Thumb-2">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 mb-md-0 mb-xl-0  border-bottom-0"
                                        data-responsive="../assets/images/media/11.jpg"
                                        ...
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive mb-0 br-5 wp-100"
                                                src="../assets/images/media/11.jpg" alt="Thumb-1">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-xl-0 mb-md-0 mb-md-0 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/10.jpg"
                                        ...
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive mb-0 br-5 wp-100"
                                                src="../assets/images/media/10.jpg" alt="Thumb-2">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/2.jpg"
                                        data-src="../assets/images/media/2.jpg"
                                        data-sub-html="<h4>Gallery Image 2</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive br-5 wp-100" src="../assets/images/media/2.jpg"
                                                alt="Thumb-2">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/9.jpg"
                                        data-src="../assets/images/media/9.jpg"
                                        data-sub-html="<h4>Gallery Image 9</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive mb-0 br-5 wp-100"
                                                src="../assets/images/media/9.jpg" alt="Thumb-1">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        ...
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive mb-0 br-5 wp-100"
                                                src="../assets/images/media/12.jpg" alt="Thumb-2">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0"
                                        data-responsive="../assets/images/media/9.jpg"
                                        ...
                                        <a href="javascript:void(0)">
                                            <img class="img-responsive mb-0 br-5 wp-100"
                                                src="../assets/images/media/20.jpg" alt="Thumb-1">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="container px-5 px-md-0">
                                <div class="row justify-content-center text-center">
                                    <div class="col-lg-8 text-center">
                                        <h3 class="header-family text-white">Clients are our most important assets.
                                        </h3>
                                        <p class="sub-text text-white pb-3">We have the best client in the market who
                                            thrives us to perform better.
                                        </p>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-lg-12">
                                        <div class="customer-logos">
                                            <div class="slide"><img
                                                    src="../assets/images/landing/companies/apple.png" alt="">
                                            </div>
                                            <div class="slide"><img
                                                    src="../assets/images/landing/companies/chrome.png"
                                                    alt=""></div>
                                            <div class="slide"><img
                                                    src="../assets/images/landing/companies/google.png"
                                                    alt=""></div>
                                            <div class="slide"><img src="../assets/images/landing/companies/edge.png"
                                                    alt=""></div>
                                            <div class="slide"><img
                                                    src="../assets/images/landing/companies/firefox.png"
                                                    alt=""></div>
                                            <div class="slide"><img
                                                    src="../assets/images/landing/companies/opera.png" alt="">
                                            </div>
                                            <div class="slide"><img
                                                    src="../assets/images/landing/companies/safari.png"
                                                    alt=""></div>
                                            <div class="slide"><img src="../assets/images/landing/companies/bing.png"
                                                    alt=""></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container px-5 px-md-0">
                                <div class="row text-center justify-content-center">
                                    <div class="col-lg-8 ps-4">
                                        ...
                                        <p class="text-default sub-text">The Noa admin template comes with ready-to-use
                                            features that are
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4 p-4 fanimate">
                                        ...
                                        <p class="text-muted mb-3 mx-1">
                                            The Noa admin code is maintained very cleanly and well-structured with
                                            proper comments.
                                        </p>
                                        <a class="mx-1" href="#">Read More <i
                                    ...
                                    <div class="col-12 col-md-4 p-4 fanimate">
                                        ...
                                        <p class="text-muted mb-3 mx-1">
                                            We included multiple demos to give a quick overview of our Noa admin
                                            template..
                                        </p>
                                        <a class="mx-1" href="#">Read More <i
                                                class="fe fe-chevron-right"></i></a>
                                    ...
                                    <div class="col-12 col-md-4 p-4 fanimate">
                                        ...
                                        <p class="text-muted mb-3 mx-1">
                                            Thanks to the Bootstrap 5 framework, because it gives us the ability to
                                            create responsive
                                            designs.
                                        </p>
                                        <a class="mx-1" href="#">Read More <i
                                    ...
                                    <div class="col-12 col-md-4 p-4 fanimate">
                                        ...
                                        <p class="text-muted mb-3 mx-1">
                                            We integrated 50+ plugins into the Noa admin template for better
                                            development.
                                        </p>
                                        <a class="mx-1" href="#">Read More <i
                                                class="fe fe-chevron-right"></i></a>
                                    ...
                                    <div class="col-12 col-md-4 p-4 fanimate">
                                        <div class="features-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                                viewBox="0 0 24 24">
                                                <rect width="18" height="6" x="3" y="3" fill="#8FBD56"
                                                    opacity=".3" rx="2" />
                                                <rect width="18" height="6" x="3" y="9" fill="#8FBD56"
                                                    opacity=".3" rx="2" />
                                                <rect width="18" height="6" x="3" y="15" fill="#8FBD56"
                                                    opacity=".3" rx="2" />
                                        ...
                                        <p class="text-muted mb-3 mx-1">
                                            Noa is built to make your work easier. Variables, elements, documentation,
                                            and reusable
                                            components.
                                        </p>
                                        <a class="mx-1" href="#">Read More <i
                                    ...
                                    <div class="col-12 col-md-4 p-4 fanimate">
                                        ...
                                        <p class="text-muted mb-3 mx-1">
                                            The documentation provides clear-cut material for the Noa admin template
                                            user can understand .
                                        </p>
                                        <a class="mx-1" href="#">Read More <i
                                                class="fe fe-chevron-right"></i></a>
                                    ...
                                    <div class="col-12 col-md-4 p-4 fanimate">
                                        ...
                                        <p class="text-muted mb-3 mx-1">
                                            We included five (5) types of the best possible chart options for your
                                            project..
                                        </p>
                                        <a class="mx-1" href="#">Read More <i
                                                class="fe fe-chevron-right"></i></a>
                            ...
                            <div class="container px-5 px-md-0">
                                <div class="row text-center">
                                    <div class="col-lg-12">
                                        ...
                                        <p class="text-default sub-text mb-5">Frequently asked questions and thieir
                                            answers.</p>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-body text-muted">
                                                        <strong>When an unknown printer took a galley.</strong> It has
                                                        survived not only
                                        ...
                                        <div class="accordion" id="accordionExample1">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseSix" class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-body text-muted">
                                                        <strong>Very popular during the Renaissance.</strong> Contrary
                                                        to popular belief,
                                                        Lorem Ipsum is not simply random text. It has roots in a piece
                                                        of lorem Ipsum is not
                                                        simply random text classical Latin literature from 45 BC, making
                                                        it over 2000 years
                            ...
                            <div class="container px-5 px-md-0">
                                <div class="row text-center justify-content-center">
                                    <div class="col-lg-8 ps-3">
                                        ...
                                        <p class="text-default sub-text mb-5">The key to this success is the hardwork
                                            and the dedication
                                ...
                                <div class="row text-center team">
                                    <div class="col-lg-3 col-sm-6 mb-5">
                                        <div class="bg-white shadow-sm p-5 team-card">
                                            <img src="{{ asset('assets/images/landing/team/1.jpg') }}" alt=""
                                                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                                            <h5 class="mb-1">Zebronski sky</h5><span class="text-muted">Team
                                                Lead</span>
                                            <ul class="social mb-0 list-inline mt-4">
                                                <li class="list-inline-item"><a href="#" class="social"><i
                                                            class="fe fe-facebook"></i></a></li>
                                                <li class="list-inline-item"><a href="#" class="social"><i
                                                            class="fe fe-instagram"></i></a></li>
                                                <li class="list-inline-item"><a href="#" class="social"><i
                                                            class="fe fe-linkedin"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 mb-5">
                                        <div class="bg-white shadow-sm p-5 team-card">
                                            <img src="{{ asset('assets/images/landing/team/2.jpeg') }}" alt=""
                                                width="100"
                                                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                                            <h5 class="mb-1">Samantha young</h5><span class="text-muted">Petugas
                                                Loket</span>
                                            <ul class="social mb-0 list-inline mt-4">
                                                <li class="list-inline-item"><a href="#" class="social"><i
                                                            class="fe fe-facebook"></i></a></li>
                                    ...
                                    <div class="col-lg-3 col-sm-6 mb-5">
                                        <div class="bg-white shadow-sm p-5 team-card">
                                            <img src="{{ asset('assets/images/landing/team/3.jpeg') }}" alt=""
                                                width="100"
                                                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                                            <h5 class="mb-1">Melessa janet</h5><span class="text-muted">Petugas
                                                Loket</span>
                                            <ul class="social mb-0 list-inline mt-4">
                                                <li class="list-inline-item"><a href="#" class="social"><i
                                                            class="fe fe-facebook"></i></a></li>
                                    ...
                                    <div class="col-lg-3 col-sm-6 mb-5">
                                        <div class="bg-white shadow-sm p-5 team-card">
                                            <img src="{{ asset('assets/images/landing/team/4.jpg') }}" alt=""
                                                width="100"
                                                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                                            <h5 class="mb-1">John trid</h5><span class="text-muted">Petugas
                                                Loket</span>
                                            <ul class="social mb-0 list-inline mt-4">
                                                <li class="list-inline-item"><a href="#" class="social"><i
                                                            class="fe fe-facebook"></i></a></li>
                                                                        ...
                                                                        <div class="card p-0">
                                                                            <div class="card-body p-0">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div
                                                                                        class="col-xl-9 col-md-9 px-0 mb-1 col-sm-9">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            class="counter-icon border border-primary text-primary">
                                                                                            <i
                                                                                                class="fe fe-headphones"></i>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div
                                                                                        class="col-xl-6 col-md-9 px-0 mb-1 col-sm-9">
                                                                                        <h5 class="mb-1 fw-semibold">
                                                                                            Phone & Email</h5>
                                                                                        <p
