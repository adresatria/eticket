            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Data</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Data</a></li>
                        <li><a href="#" class="slide-item">Data Admin</a></li>
                        <li><a href="form-layouts.html" class="slide-item">Data Petugas</a></li>
                    </ul>
                </li>
            </ul>
