                    ...
                    <div class="card-body">
                        <form action="{{ route('actionlogin') }}" method="post" class="login100-form validate-form">
                            ...
                            <div class="wrap-input100 validate-input"
                                ...
                                <input class="input100" type="email" id="email" name="email" placeholder="Email" class="form-control" required="">
                            ...
                            <div class="wrap-input100 validate-input" data-bs-validate="Password is required">
                                <input class="input100" type="password" id="password" name="password" placeholder="Password" class="form-control" required="">
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
